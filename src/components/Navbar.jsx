...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <div className="flex justify-between items-center sm:px-12 md:px-24 xl:px-40 py-4 sticky top-0 z-50 backdrop-blur-xl bg-white/50 font-medium px-4 dark:bg-gray-900/70">
      {/* Logo */}
      <img
